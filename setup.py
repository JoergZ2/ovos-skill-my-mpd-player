...
SKILL_CLAZZ = "MyMpdPlaylist"  # Make sure it matches __init__.py class name
VERSION = "0.0.2"
URL = "https://github.com/JoergZ2/ovos-skill-my-mpd-player"
AUTHOR = "JoergZ2"
EMAIL = ""
LICENSE = "Apache2.0"
DESCRIPTION = "Skill for controlling MPD"
